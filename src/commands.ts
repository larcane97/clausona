  ...
  switch (command) {
    ...
    case "doctor":
      return [
        ...
        `    ${dim("checked for it and neither is reported missing. Four other things are:")}`,
        "",
        `    ${dim("- its base URL, which only a hand-edited profiles.json can break;")}`,
        ...
        `    ${dim("  reach the profile's endpoint;")}`,
