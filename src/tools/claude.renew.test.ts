...
// `security` and with it the Keychain of the machine running the suite. A file of its own:
// claude.test.ts runs the real spawn against the `security` stand-in on PATH.
